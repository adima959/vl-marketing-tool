...
export const DASHBOARD_METRIC_COLUMNS: MetricColumn[] = [
  {
    ...
    label: 'New Customers',
    shortLabel: 'Cust',
    description: 'Unique new customers from subscriptions in the selected period',
    format: 'number',
    category: 'basic',
    defaultVisible: true,
    width: 80,
  ...
  },
  {
    ...
    label: 'Subscriptions',
    shortLabel: 'Subs',
    description: 'Total new subscriptions created (trials + direct sales)',
    format: 'number',
    category: 'basic',
    defaultVisible: true,
    width: 80,
  ...
  {
    id: 'trials',
    label: 'Trials — counted by subscription date. CRM may differ as it counts by invoice date.',
    shortLabel: 'Trials',
    description: 'Subscriptions that started with a trial period, counted by subscription date',
    format: 'number',
    category: 'basic',
    defaultVisible: true,
    width: 80,
