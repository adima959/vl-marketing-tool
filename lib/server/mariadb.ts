...
import { classifyDatabaseError, MARIADB_ERROR_CONFIG } from '@/lib/server/dbErrorClassifier';
...
export async function executeMariaDBQuery<T = Record<string, unknown>>(
  ...
  try {
    ...
    throw classifyDatabaseError(error, query, params, MARIADB_ERROR_CONFIG);
  }
}
